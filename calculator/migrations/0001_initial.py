# Generated by Django 4.2.7 on 2025-10-04 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filament_usage', models.ForeignKey(help_text='پروژه با فیلامنت مشخص', on_delete=django.db.models.deletion.CASCADE, to='calculator.filamentusage', verbose_name='مدل (فیلامنت)')),
            ],
            options={
                'verbose_name': 'فروش',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calculator.project', verbose_name='پروژه'),
        ),
        migrations.AlterUniqueTogether(
            name='filamentusage',
            unique_together={('filament', 'project')},
        ),
    ]
